...
/** Builds an mdp model consisting of a separate classifier (or ensemble of classifiers) to predict each feature, reward, and termination probability. Thus forming a complete model of the MDP. */
...
public:
  ...
  /** Default constructor
      ...
      \param exploreType identifies how to combine multiple models
  ...
  */
  ...
  /** Copy Constructor for Factored Model */
  ...
  /** Tell MDP Tree its a new episode so it can reset things */
  void newEpisode();
